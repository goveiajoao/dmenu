...
install: all
	...
	cp -f dmenu dmenu_path dmenu_run dmenu_path_desktop dmenu_run_desktop stest dmenu_qalc $(DESTDIR)$(PREFIX)/bin
	...
	chmod 755 $(DESTDIR)$(PREFIX)/bin/dmenu_qalc
